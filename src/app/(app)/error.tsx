...
/**
 * App-level error boundary. Any server/client component that throws inside the
 * (app) group renders this instead of the raw "Application error" screen.
 */
  ...
  return (
    <div className="flex min-h-[60vh] items-center justify-center px-6">
      <div className="card view-in w-full max-w-md p-8 text-center">
        ...
        {error?.digest && (
          <p className="mt-3 font-mono text-[0.65rem] tracking-wider text-mist/40">
            {t("errors.ref")}: {error.digest}
          </p>
        )}
